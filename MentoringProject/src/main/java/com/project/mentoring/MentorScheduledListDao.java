...
public class MentorScheduledListDao {
	DataSource dataSource;

	public MentorScheduledListDao() {
	...
	public ArrayList<MentorScheduledListDto> showScheduledList(int userPk){
		
		
		
		ArrayList<MentorScheduledListDto> mentorScheduledListDtos = new ArrayList<MentorScheduledListDto>();
		...
		try {
			...
			String mentorScheduledListShowQuery1 = "select py.paymentpk, s.schedulepk, u.username, u.userphone, mj.majorname, sb.submajorname, p.price ";
			...
			while(resultSet.next()) {
				...
				MentorScheduledListDto mentorScheduledListDto = new MentorScheduledListDto(paymentPk,scheduledPk, userName, userPhone, majorName, subMajorName, price);
				mentorScheduledListDtos.add(mentorScheduledListDto);				
			}
		...
		return mentorScheduledListDtos;
	}
