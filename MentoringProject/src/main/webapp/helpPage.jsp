...
<html>
	...
	공지사항 [<span id="notice-toggle" onclick="openCloseTocNotice()">보이기</span>]
	<ol id="notice-content">
	<table border="1">
		<tr>
			<th>번호</th>
			<th>제목</th>
		...
		<tr>
			<td>${dto.noticepk }</td>
			<td><a href="AdminAnnouncementPage.do?noticepk=${dto.noticepk }">${dto.noticetitle }</a></td>
			<td>${dto.indate }</td>
		</tr>
		</c:forEach>
	</table>
	...
	QnA [<span id="qna-toggle" onclick="openCloseTocQna()">보이기</span>]
	<ol id="qna-content">
	<table border="1">
		<tr>
			<th>번호</th>
		...
		<tr>
			<td>${dto.noticepk }</td>
			<td><a href="QnaPage.do?noticepk=${dto.noticepk }">${dto.noticetitle }</a></td><!-- qna 위치 입력 -->
			<td>${dto.indate }</td>
		</tr>
		</c:forEach>
	</table>
	</ol><br>
	도움말 [<span id="help-toggle" onclick="openCloseTocHelp()">보이기</span>]
	<ol id="help-content">
	  <li>
	  ...
	  <li>
		...
		<div class="faq-content">
		  ...
		  <div class="answer" id="ans-6-3">
			...
			Copyright ©<a href="">Corp</a>All rights reserved.
      
	<!-- 목차 선택시 내용 숨기기/열기 스크립트-->	      

	
	<script>
	  function openCloseTocNotice() {		  
		  if(document.getElementById('notice-content').style.display === 'block') {
	      document.getElementById('notice-content').style.display = 'none';
	      document.getElementById('notice-toggle').textContent = '보이기';
	    } else {
	      document.getElementById('notice-content').style.display = 'block';
	      document.getElementById('notice-toggle').textContent = '숨기기';
	    }
	  }
	  function openCloseTocQna() {		  
		  if(document.getElementById('qna-content').style.display === 'block') {
	      document.getElementById('qna-content').style.display = 'none';
	      document.getElementById('qna-toggle').textContent = '보이기';
	    } else {
	      document.getElementById('qna-content').style.display = 'block';
	      document.getElementById('qna-toggle').textContent = '숨기기';
	    }
	  }
	  function openCloseTocHelp() {		  
		  if(document.getElementById('help-content').style.display === 'block') {
	      document.getElementById('help-content').style.display = 'none';
	      document.getElementById('help-toggle').textContent = '보이기';
	    } else {
	      document.getElementById('help-content').style.display = 'block';
	      document.getElementById('help-toggle').textContent = '숨기기';
	    }
	  }
	</script> 	
	
	
    <!-- 목차 클릭시 내용 접기/ 펴기 스크립트-->
