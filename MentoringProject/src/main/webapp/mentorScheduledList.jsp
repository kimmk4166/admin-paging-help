		...
		<nav>
            ...
            <div class="menu">
                <ul>                    
                    ...
                    <li><a href="/MentoringProject/mentorScheduledCompleteListPage.do">확정된 예약보기</a></li>
                </ul>
            </div>
        </nav>
</header>
...
<main>
	...
	<div class="main-box">
	    ...
	    <section>
	      <c:forEach items="${scheduledList }" var="scheduledList">
			<div class="job-contain-box">
		        <h3> 스케쥴 번호 : ${scheduledList.scheduledPk } </h3>
		        <h4> 예약자 이름 : ${scheduledList.userName }</h4>
		        <span> 예약자 번호 :${scheduledList.userPhone }</span><br>
